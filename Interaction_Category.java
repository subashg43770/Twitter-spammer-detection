...
public class Interaction_Category 
{
	...
	public static void reputation_and_followerRatio() throws IOException,InterruptedException
		...
		//Id set p of the users to whom reputation and follower ration has to be calculated
	...
	public static void clus_coefficient() throws IOException,FileNotFoundException,InterruptedException,NumberFormatException
	{
		...
		//Loop to map p the follower and friends of every user and finds friends and followers corresponding to every neighbor and friends  
			...
			else
			{
				...
				{		
					...
					if(Collections.binarySearch(friends_id_list, cnode)>=0)
					{
						...
						List<Integer> cnode_fol_set=friends_fol.get(cnode);
